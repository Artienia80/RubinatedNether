...
public class RNPlacedFeatures {
    ...
    public static void bootstrap(BootstapContext<PlacedFeature> context) {
        ...
        register(context, MOLTEN_RUBY_ORE_PLACED_KEY, configuredFeatures.getOrThrow(RNConfiguredFeatures.MOLTEN_RUBY_ORE_KEY),
            RNOrePlacement.commonOrePlacement("molten_ruby_ore",100,
                HeightRangePlacement.triangle(VerticalAnchor.absolute(0), VerticalAnchor.absolute(40))));
        register(context, RUBINATED_BLACKSTONE_PLACED_KEY, configuredFeatures.getOrThrow(RNConfiguredFeatures.RUBINATED_BLACKSTONE_KEY),
            RNOrePlacement.commonOrePlacement("rubinated_blackstone",250,
