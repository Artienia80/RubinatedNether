...
public class BronzeShotProjectileModel extends EntityModel<BronzeShotProjectileEntity> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition bronze_shot = partdefinition.addOrReplaceChild("bronze_shot", CubeListBuilder.create().texOffs(4, 10).addBox(-11.0F, -11.0F, 5.0F, 6.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(8.0F, 24.0F, -8.0F));
