...
public class TarnishingRotatingBlock extends HorizontalDirectionalBlock implements TarnishingBronze {
	public static final MapCodec<TarnishingRotatingBlock> CODEC = RecordCodecBuilder.mapCodec(
		...
		.apply(blockInstance, TarnishingRotatingBlock::new)
	);
	private final TarnishStage tarnishStage;

	@Override
	public MapCodec<TarnishingRotatingBlock> codec() {
		return CODEC;
	}

	public TarnishingRotatingBlock(TarnishStage tarnishStage, Properties properties) {
		super(properties);
