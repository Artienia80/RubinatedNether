...
public class RubinatedNetherConfiguredFeatures {
		...
		context.register(
			...
			new ConfiguredFeature<>(
				...
				new OreConfiguration(
					...
					RubinatedNetherBlocks.NETHER_RUBY_ORE.get().defaultBlockState(), 
					3
				)
			)
		);
		...
		context.register(
			...
			new ConfiguredFeature<>(
				...
				new OreConfiguration(
					...
					RubinatedNetherBlocks.MOLTEN_RUBY_ORE.get().defaultBlockState(), 
					5
				)
			)
		);
		...
		context.register(
			...
			new ConfiguredFeature<>(
				...
				new OreConfiguration(
					...
					RubinatedNetherBlocks.RUBINATED_BLACKSTONE.get().defaultBlockState(), 
					25
				)
			)
		);
