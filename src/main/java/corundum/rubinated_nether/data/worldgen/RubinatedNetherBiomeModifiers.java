...
public class RubinatedNetherBiomeModifiers {
	...
	public static void bootstap(BootstrapContext<BiomeModifier> context) {
		...
		context.register(
			...
			new AddFeaturesBiomeModifier(
				...
				HolderSet.direct(placedFeatures.getOrThrow(RubinatedNetherPlacedFeatures.NETHER_RUBY_ORE)),
		...
		context.register(
			...
			new AddFeaturesBiomeModifier(
				biomes.getOrThrow(BiomeTags.IS_NETHER),
				HolderSet.direct(placedFeatures.getOrThrow(RubinatedNetherPlacedFeatures.MOLTEN_RUBY_ORE)),
		...
		context.register(
			...
			new AddFeaturesBiomeModifier(
				biomes.getOrThrow(BiomeTags.IS_NETHER),
				HolderSet.direct(placedFeatures.getOrThrow(RubinatedNetherPlacedFeatures.RUBINATED_BLACKSTONE)),
				GenerationStep.Decoration.UNDERGROUND_ORES
			)
		);
	}
