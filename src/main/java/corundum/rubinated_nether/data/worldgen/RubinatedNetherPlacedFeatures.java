...
public class RubinatedNetherPlacedFeatures {
	...
	public static void bootstap(BootstrapContext<PlacedFeature> context) {
		...
		context.register(
			NETHER_RUBY_ORE, 
			new PlacedFeature(
				configuredFeatures.getOrThrow(RubinatedNetherConfiguredFeatures.NETHER_RUBY_ORE), 
				orePlacement(
					1,
		...
		context.register(
			MOLTEN_RUBY_ORE, 
			new PlacedFeature(
				configuredFeatures.getOrThrow(RubinatedNetherConfiguredFeatures.MOLTEN_RUBY_ORE), 
				orePlacement(
					100,
					HeightRangePlacement.triangle(
		...
		context.register(
			...
			new PlacedFeature(
				configuredFeatures.getOrThrow(RubinatedNetherConfiguredFeatures.RUBINATED_BLACKSTONE), 
				orePlacement(
					250,
					HeightRangePlacement.triangle(
