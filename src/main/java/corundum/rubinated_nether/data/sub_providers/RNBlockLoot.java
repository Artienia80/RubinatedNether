...
public class RNBlockLoot extends BlockLootSubProvider {
	...
	protected void generate() {
		...
		this.dropSelf(RNBlocks.DISCOLORED_CUT_BRONZE.get());
		this.dropSelf(RNBlocks.CORRODED_CUT_BRONZE.get());
		this.dropSelf(RNBlocks.TARNISHED_CUT_BRONZE.get());
		this.dropSelf(RNBlocks.CRYSTALLIZED_CUT_BRONZE.get());
