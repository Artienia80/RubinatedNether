...
import corundum.rubinated_nether.content.RubinatedNetherCreativeTabs;
...
public class RubinatedNether {
	...
	public RubinatedNether(IEventBus modEventBus, ModContainer modContainer) {
		...
		RubinatedNetherCreativeTabs.CREATIVE_MODE_TABS.register(modEventBus);

		modEventBus.addListener(Datagen::datagen);
		modEventBus.addListener(RubinatedNetherCreativeTabs::addCreative);
	}
}
